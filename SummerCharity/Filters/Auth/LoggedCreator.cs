...
{
    public class LoggedCreator : AuthorizationFilterAttribute
    {
        public override void OnAuthorization(HttpActionContext actionContext)
        {
            ...
            else
            {
                ...
                else if (tk != null && !AuthService.IsRoleToken(tk, "CREATOR"))
                {
                    actionContext.Response = actionContext.Request.CreateResponse(System.Net.HttpStatusCode.Unauthorized, new { Msg = "No Creator permission" });
                }
            }
